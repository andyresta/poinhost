...
// sehingga nama role menjadi "acmeapp|OWNER" dan tidak pernah cocok dengan
// user mana pun.
func TestRunPostgresMemaksaPemisahTab(t *testing.T) {
	...
	cmd := "sudo -u postgres psql -v ON_ERROR_STOP=1 -d " + shellQuote("acmeapp") +
