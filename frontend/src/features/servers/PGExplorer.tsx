...
// ulang di setiap pindah halaman/edit sel), TAPI dengan satu beda mendasar:
// koneksi PostgreSQL SELALU terikat ke SATU database (tidak ada padanan
// "USE database" MySQL) — pindah database di sidebar berarti membuka
// koneksi cache YANG BERBEDA di belakang layar (lihat pgexplore.go), bukan
// menjalankan statement di koneksi yang sama. Role PostgreSQL juga tidak
// punya konsep "host" seperti user MySQL, jadi kredensial di sini cukup
// serverId+username.
//
